...
\title{Dimensional reduction for sampled priors}
...
\ed{The MC for the posterior will typically require evaluation of
...
\ed{Our assumptions that the likelihood is normal in $\hatc$ and that we can
...
\ed{The algebra to derive the compression scheme that minimizes the mean shift
...
\ed{The compression technique is applicable to any inference with a
...
\bibitem[Weaverdyck et al.(2025)]{y6maglim} Weaverdyck, N. et al.\ 2025 (in preparation)
