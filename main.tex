...
the nuisance prior, and is likely to be a good approximation when
...
exponentially with the number of retained modes.  We have somewhat arbitrarily chosen a threshold of $\chi^2<0.025$ for each galaxy sample in order to keep the total impact from modal compression $\ll 1.$ This is attained with $M=3$ modes for this bin.  The right side of Figure~\ref{fig:chiresid} plots the individual modes
...
\bibitem[Giannini et al.(2025)]{y6gg} Giannini, G. et al.\ 2025
  (lenses paper) ????
